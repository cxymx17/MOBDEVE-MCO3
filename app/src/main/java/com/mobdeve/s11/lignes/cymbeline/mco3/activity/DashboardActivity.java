...
/**
 * DashboardActivity displays a dashboard interface for users to track their daily activities
 * such as sleep hours, water intake, and brushing count. It retrieves data from a SQLite database
 * using a DatabaseHelper instance and updates the corresponding progress bars accordingly.
 * Users can navigate to different activities for updating their sleep hours, water intake, and
 * brushing count by clicking on specific elements within the dashboard. Overall progress percentage
 * is calculated based on the progress of individual activities and displayed to the user.
 */
