...
/**
 * DatabaseHelper manages the SQLite database for storing user information, sleep hours,
 * brush count, and water intake. It provides methods for creating tables, inserting,
 * updating, and retrieving data. Additionally, it handles data validation and deletion
 * operations related to user activities such as sleep tracking, brushing count, and water
 * intake monitoring.
 */
